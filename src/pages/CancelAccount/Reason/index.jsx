...
const CancellationReason = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto p-5 font-sans">
      ...
      <div className="mb-8">
        <select className="w-full p-3 text-gray-500 bg-gray-900 rounded border border-gray-600 text-base">
      ...
      <textarea
        className="w-full p-3 bg-gray-900 rounded border border-gray-600 text-base h-32"
