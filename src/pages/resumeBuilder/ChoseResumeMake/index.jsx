                  ...
                  {resumes.length > 0 && (
                    <div className="mt-20 w-full flex flex-col items-center justify-center gap-6">
                      {resumes.map((resume) => (
                        <div
                          key={resume._id}
                          className="w-full lg:w-[80%] rounded-md border border-primary bg-modalPurple px-4 py-2 flex flex-col gap-4"
                        >
                          <div className="flex flex-col sm:flex-row items-center gap-4">
                            ...
                            <div className="flex flex-col sm:flex-row justify-between items-center sm:items-start w-full gap-4 sm:px-5">
                              <div>
                                <p className="text-lg sm:text-4xl font-semibold text-center sm:text-left text-primary text-nowrap">
                                  {resume.resumeTitle || resume.name}
                                </p>
                              </div>
                              <div className="flex flex-wrap justify-center sm:justify-end gap-4 w-full">
                                <Button
                                  className="p-2 gap-2 px-4 sm:px-6 flex items-center text-navbar font-bold rounded-full bg-gradient-to-b from-gradientStart to-gradientEnd hover:ring-2 hover:ring-gradientEnd focus:ring-2 focus:ring-gradientEnd"
                                  onClick={() =>
...
//   // Effect to remove specified items from localStorage on component mount
//   useEffect(() => {
//     const keysToRemove = [
//       "resumeBuilderAchievements",
//       "resumeBuilderCertifications",
...
//       description:
//         "We are looking to hire a skilled Magento Developer to build and maintain eCommerce websites for our...",
...
//       description:
//         "Exciting opportunity to join a team of passionate engineers working on cutting-edge front-end tech...",
...
//       description:
//         "Join our dynamic team and help develop robust and scalable APIs for next-gen applications...",
...
//                       <div className="p-2 w-[100%] md:w-[100%]  rounded-md border border-primary items-center justify-center">
//                         <p className="text-xl md:text-2xl font-semibold pl-5">
//                           Latest Scans
//                         </p>
//                       </div>
//                     </div>

//                     {/* Mapping over the trackData to render TrackComponent */}
